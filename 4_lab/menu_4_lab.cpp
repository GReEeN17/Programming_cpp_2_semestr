...
void Menu4::set_cc(std::set<CircleClass*> &all_circles) {
    double x, y;
    int r;
...
void Menu4::set_rc(std::set<RectangleClass*> &all_rect) {
    ...
    all_rect.insert(&gap_rc);
}

void Menu4::draw_cc(std::set<CircleClass*> &all_circles) {
...
void Menu4::draw_rc(std::set<RectangleClass*> &all_rect) {
    for (auto i: all_rect) {
        std::cout << "-------------------" << "\n";
        i->draw();
    }
...
void Menu4::per_cc(std::set<CircleClass*> &all_circles) {
    double sum_p = 0;
    for (auto i: all_circles) {
        sum_p += i->perimeter();
    }
...
void Menu4::per_rc(std::set<RectangleClass*> &all_rect) {
    double sum_p = 0;
    for (auto i: all_rect) {
        sum_p += i->perimeter();
    }
...
void Menu4::sq_cc(std::set<CircleClass*> &all_circles) {
    double sum_sq = 0;
    for (auto i: all_circles) {
        sum_sq += i->square();
    }
...
void Menu4::sq_rc(std::set<RectangleClass*> &all_rect) {
    double sum_sq = 0;
    for (auto i: all_rect) {
        sum_sq += i->square();
    }
...
void Menu4::cm_cc(std::set<CircleClass*> &all_circles) {
    double x = 0, y = 0, p = 0;
    for (auto i: all_circles) {
...
void Menu4::cm_rc(std::set<RectangleClass*> &all_rect) {
    double x = 0, y = 0, p = 0;
    for (auto i: all_rect) {
...
void Menu4::sz_cc(std::set<CircleClass*> &all_circles) {
...
void Menu4::sz_rc(std::set<RectangleClass*> &all_rect) {
    unsigned int sum_sz = 0;
    for (auto i: all_rect) {
        sum_sz += i->size();
    }
